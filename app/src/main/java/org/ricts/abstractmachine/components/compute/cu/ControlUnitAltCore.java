...
public abstract class ControlUnitAltCore implements ControlUnitInterface {
    ...
    protected abstract CuFsmInterface createMainFSM(FetchCore regCore, CompCore core);
    ...
    public ControlUnitAltCore(CompCore core, ReadPort instructionCache) {
