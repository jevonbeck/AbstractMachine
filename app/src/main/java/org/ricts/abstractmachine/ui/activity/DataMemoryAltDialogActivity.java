...
public class DataMemoryAltDialogActivity extends MemoryContentsAltDialogActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DecoderUnit decoderUnit = InspectAltActivity.getDecoderUnit(getResources(), dataBundle);
        final MemAltFragment.AssemblyMemoryData memoryData = dataBundle.getParcelable(MEM_DATA_KEY);
