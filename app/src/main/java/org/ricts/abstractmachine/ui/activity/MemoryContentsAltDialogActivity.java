...
public abstract class MemoryContentsAltDialogActivity extends AppCompatActivity {
    ...
    protected void sendMemoryData(Context context, int memoryAddress,
                                  MemAltFragment.AssemblyMemoryData memoryData,
                                  String memoryType) {
        LocalBroadcastManager broadcastManager = LocalBroadcastManager.getInstance(context);
        Intent intent = new Intent(MemAltFragment.UPDATE_MEM_LOCATION_ACTION);
